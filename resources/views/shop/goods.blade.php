                    ...
                    <div class="side-item">
                        @foreach($goods as $good)
                            ...
                            <div class="product-thumb clearfix">
                                {{--<div class="image"><a href="product.html"><img src="http://idpz.ir/assets/images/arts/{{$good->pic}}" alt="تی شرت کتان مردانه" title="تی شرت کتان مردانه" class="img-responsive" /></a></div>--}}
                                <div class="caption">
