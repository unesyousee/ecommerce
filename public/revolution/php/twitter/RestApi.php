...
class RestApi
{
     ...
     *
     * @return \TwitterPhp\Connection\Customer
     * @throws TwitterRestApiException
     */
    public function connectAsUser()
    {
        ...
        return new Customer($this->_consumerKey,$this->_consumerSecret,$this->_accessToken,$this->_accessTokenSecret);
    }
